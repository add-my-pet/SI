...
%  Allowed names of taxa match the names of the tree nodes at http://www.bio.vu.nl/thb/deb/deblab/add_my_pet/species_tree_Animalia.html
  ...
  legend = {...
    ...
    {'o', 5, 2, [0 0 1], [1 1 1]}, 'Radiata'; ...
    {'o', 5, 2, [0 1 1], [1 1 1]}, 'Spiralia'; ...
    {'o', 5, 2, [0 1 0], [1 1 1]}, 'Ecdysozoa'; ....
    {'o', 5, 2, [1 0 0], [1 1 1]}, 'Aves'; ....
    {'o', 5, 2, [1 0 0], [1 1 1]}, 'Mammalia'; ....
    {'o', 5, 2, [1 0 1], [1 0 1]}, 'Vertebrata'; ....
    {'o', 5, 2, [0 0 0], [1 1 1]}, 'Deuterostomata'; ....
  };
  ...
  for i=1:length(fig)
    switch fig(i)
      case 1 % fig 1a: Li-R 
        LiRi = read_allStat({'L_i','R_i','c_T'});
        [HfigLR, HlegLR] = shstat([LiRi(:,1), LiRi(:,2)./LiRi(:,3)], legend); 
      ...
      case 2 % fig 1b: Li-pR
        LipR = read_allStat({'L_i','p_Ri','c_T'});
        [HfigLpR, HlegLpR] = shstat([LipR(:,1), LipR(:,2)./LipR(:,3)], legend); 
